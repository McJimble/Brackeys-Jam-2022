...
//     version 1.2.0
//     from Assets/CharacterInputs 1.inputactions
//
...
public partial class @CharacterInputs1 : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @CharacterInputs1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""CharacterInputs 1"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @CharacterInputs1 m_Wrapper;
        public PlayerActions(@CharacterInputs1 wrapper) { m_Wrapper = wrapper; }
